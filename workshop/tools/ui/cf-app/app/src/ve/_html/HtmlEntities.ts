...
export const _applyEncodingMap = (str, map) => {
    // summary:
...
const _applyDecodingMap = (str, map) => {
    // summary:
...
export const encode = (str/*string*/, m?: any /*array?*/) => {
    // summary:
    ...
    if (str) {
        if (!m) {
            ...
            // as well.
            str = _applyEncodingMap(str, html);
            str = _applyEncodingMap(str, latin);
...
export const decode = (str/*string*/, m /*array?*/) => {
    // summary:
    //		Function to obtain an entity encoding for a specified character
    // str:
    ...
    if (str) {
        if (!m) {
            // Apply the basic mappings.  HTML should always come first when decoding
            // as well.
            str = _applyDecodingMap(str, html);
            str = _applyDecodingMap(str, latin);
